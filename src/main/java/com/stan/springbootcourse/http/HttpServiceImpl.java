...
public class HttpServiceImpl implements HttpService, InitializingBean {
    ...
    @Override
    public StanHttpResponse postXml(String endpointURL, String content) {
    ...
    public StanHttpResponse postXmlIgnoreCert(String endpointURL, String content) {
        log.info("inside HttpService::: postXmlIgnoreCert");
        Map<String, String> headers = new HashMap();
        return postXmlIgnoreCert(endpointURL, headers, content, "application/xml");
    }


    @Override
    public StanHttpResponse getJson(String endPoint, String resolvedRequestBody) {
        // TODO Auto-generated method stub
        return null;
    }
    ...
    @Override
    public StanHttpResponse getXml(String endPoint, String resolvedRequestBody) {
        // TODO Auto-generated method stub
        return null;
    }
    ...
    @Override
    public StanHttpResponse postXml(String endpointURL, Map<String, String> headers, String content) {
        return postXml(endpointURL, headers, content, "application/xml");
    }


    @Override
    public StanHttpResponse postXml(String endpointURL, Map<String, String> headers, String content, String contentType) {
        StanHttpResponse httpCallResponse = new StanHttpResponse();
        try {
            CloseableHttpResponse httpResponse = null;
            ResponseHandler<StanHttpResponse> responseHandler = new ResponseHandler<StanHttpResponse>() {

                @SuppressWarnings("unchecked")
                @Override
                public StanHttpResponse handleResponse(final HttpResponse response) throws IOException {
                    StanHttpResponse responseT = new StanHttpResponse();
                    StatusLine statusLine = response.getStatusLine();
                    HttpServiceImpl.LOG.info("statusLine from XML Response from HTTP :" + statusLine.getStatusCode());
                    ...
                    String json = EntityUtils.toString(entity);
                    EntityUtils.consumeQuietly(entity);
                    HttpServiceImpl.LOG.info("Raw XML Response from HTTP :" + json);
            ...
            try {
                ...
                if (httpResponse != null) {
                    try {
                        ...
                        HttpServiceImpl.LOG.info("Error occurred on XML HTTP call :", e);
                    }
                }
            }
        } catch (Exception e) {
    ...
    public StanHttpResponse postXmlIgnoreCert(String endpointURL, Map<String, String> headers, String content, String contentType) {
        log.info("inside HttpServiceImp::: postXmlIgnoreCert");
        StanHttpResponse httpCallResponse = new StanHttpResponse();
        try {
            CloseableHttpResponse httpResponse = null;
            ResponseHandler<StanHttpResponse> responseHandler = new ResponseHandler<StanHttpResponse>() {
            ...
            CloseableHttpClient httpclient = getInsecureHttpClient();
    ...
    @Override
    public StanHttpResponse postJson(String endpointURL, Map<String, String> headers, String content) throws Exception {
        StanHttpResponse httpCallResponse = new StanHttpResponse();
        try {
            CloseableHttpResponse httpResponse = null;
            ResponseHandler<StanHttpResponse> responseHandler = new ResponseHandler<StanHttpResponse>() {
    ...
    @Override
    public StanHttpResponse postJson(String endpointURL, String content) throws Exception {
        // TODO Auto-generated method stub
        return null;
    }

    //Ignore certificate check
    private CloseableHttpClient getInsecureHttpClient() throws Exception {
        ...
        SSLConnectionSocketFactory socketFactory =
            new SSLConnectionSocketFactory(
                sslContext,
                NoopHostnameVerifier.INSTANCE // ignore hostname check
            );

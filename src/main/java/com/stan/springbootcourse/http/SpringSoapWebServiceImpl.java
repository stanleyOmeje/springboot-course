...
public class SpringSoapWebServiceImpl implements SoapWebService {
    ...
    public StanHttpResponse sendSoapMessage(String payload, String endPoint) {
        StanHttpResponse response = new StanHttpResponse();
        /*
    ...
    @Override
    public StanHttpResponse sendPostIgnoreSSL(String getPayload, String endPoint) throws IOException, NoSuchAlgorithmException, KeyManagementException {
        StanHttpResponse httpResponse = new StanHttpResponse();
    ...
    @Override
    public StanHttpResponse sendPostIgnoreSSL(String getPayload, String endPoint, Map<String, String> headers)
